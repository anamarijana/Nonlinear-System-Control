...
sim(['usvojen_lin_regulacija_nelin_sim.slx']);
...
ylabel('S [g/l]')
grid
sgtitle('PID regulacija: promenljive stanja u vremenu')
...
ylabel('x2 [g/l]')
grid
title('PID regulacija: fazni dijagram')
...
ylabel('S [g/l]')
xlabel('vreme [h]')
legend('PID regulator','referentna vrednost')
